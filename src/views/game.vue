...
class CardItem {
   ...
   static colorType = {
      ...
      14: {background: '#99FFFF'},
      15: {background: '#AAFFEE'},
      16: {background: '#BBFFEE'},
      17: {background: '#99FF99'},
      18: {background: '#CCFF99'},
      19: {background: '#EEFFBB'},
      20: {background: '#FFFFBB'},
      21: {background: '#FFEE99'},
      22: {background: '#FFDDAA'},
